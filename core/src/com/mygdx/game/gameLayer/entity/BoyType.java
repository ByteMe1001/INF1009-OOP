...
public enum BoyType {
    ...
    BoyType(int id, int health, float x, float y, float scale, float width, float height, float speed, int direction, boolean isAlive, Character control, boolean isCollidable, String texturePath) {
        this.id = id;
        this.health = health;
        this.x = x;
        this.y = y;
