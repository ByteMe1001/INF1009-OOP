...
public class CongratsScene extends Scene implements iIO {
    ...
    public CongratsScene(SceneManager sceneManager, EntityManager entityManager, SoundManager soundManager, SpriteBatch batch) {
    ...
    public void show() {
        ...
        addCenterText(mainTable, "You Won! Thank you for playing :)");
    ...
    @Override
    public void dispose() {
        CongratsScene.super.getSoundManager().stopAll(); // Stop music only, do not dispose sound manager
